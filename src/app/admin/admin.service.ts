...
export class AdminService {
  ...
  registreerVerantwoordelijke(gebruiker): any {
    return this.http.post(
      this.$link + 'api/gebruiker/registreerverantwoordelijke',
      gebruiker
    );
  }
  ...
  updateGebruiker(id, gebruiker): any {
    return this.http.put(
      this.$link + 'api/gebruiker/updatelid/' + id,
      gebruiker
    );
  }
  ...
  getVerenigingenByEvenementId(evenementId): any {
    return this.http.get(
      this.$link +
      'api/evenementVereniging/getVerenigingenByEvenementId/' +
      evenementId
    );
  }
  ...
  getVerenigingByIdMetLeden(id): any {
    return this.http.get(
      this.$link + 'api/vereniging/verenigingbyidmetleden/' + id
    );
  }

  registreerEvenementVereniging(evenementVereniging) {
    return this.http.post(
      this.$link + 'api/evenementVereniging/postEvenementVereniging',
      evenementVereniging
    );
  }
  ...
  deleteVerenigingFromEvenement(ids) {
    return this.http.post(
      this.$link + 'api/evenementvereniging/deleteverenigingfromevenement',
      ids
    );
  }
  ...
  createTijdsregistraties(tijdsregistratie): any {
    return this.http.post(
      this.$link + 'api/tijdsregistratie',
      tijdsregistratie
    );
  }
  ...
  updateTijdsregistratie(id, tijdsregistratie): any {
    return this.http.put(
      this.$link + 'api/tijdsregistratie/' + id,
      tijdsregistratie
    );
  }
  ...
  deleteTaak(id: number): any {
    return this.http.delete(this.$link + 'api/taak/deleteTaak/' + id);
  }
